...
NOISE_WORDS: Set[str] = {
    "rt", "amp", "dont", "didnt", "doesnt", "hey", "got", "youre", "oh", "yes",
    "people", "today", "watch", "make", "use", "using", "going", "come", "start",
    "stop", "pay", "say", "like", "season", "pm", "series", "xs", "size", "big", "im", "ill", "ive", "mpoints", "th",
}
...
# ---------------------------------------------------------------------------
# 可视化 Topic 0: E-commerce & Promotion Keywords / Topic 1: Politics & Social Discourse
# ---------------------------------------------------------------------------
...
def main():
    ...
    ap.add_argument("--data", default="filter_2017_cleaned_aligned_data.csv", help="CSV 数据路径")
